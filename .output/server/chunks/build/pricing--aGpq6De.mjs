import { I as I$1, E as A$3, F as k$1, G as s$4, H as o$2, J as f, K as E$2, L as s$3, T as T$2, e as useAsyncData, q as queryContent, c as createError, f as useSeoMeta, M as o$1, l as useUI, N as l$3, O as useId, P as useAppConfig, _ as __nuxt_component_0$2, z as __nuxt_component_1$2, j as __nuxt_component_0$4, i as __nuxt_component_1, Q as __nuxt_component_0$1 } from './server.mjs';
import { defineComponent, onMounted, onUnmounted, unref, ref, computed, provide, inject, watch, h, Fragment, useSSRContext, withAsyncContext, withCtx, isRef, createVNode, mergeProps, openBlock, createBlock, renderList, toRef, renderSlot, createTextVNode, toDisplayString, createCommentVNode, createSlots } from 'vue';
...
import { _ as __nuxt_component_2 } from './Divider-DWFz1W51.mjs';
import { _ as _sfc_main$7 } from './LandingSection-CftQmrqB.mjs';
...
defineComponent({ name: "Label", props: { as: { type: [Object, String], default: "label" }, passive: { type: [Boolean], default: false }, id: { type: String, default: null } }, setup(t, { slots: n, attrs: i }) {
  ...
  return onMounted(() => onUnmounted(o2.register(e))), () => {
    ...
    return f2 && (delete u.onClick, delete u.htmlFor, delete s2.onClick), A$3({ ourProps: u, theirProps: s2, slot: p2, attrs: i, slots: n, name: l2 });
  };
} });
...
defineComponent({ name: "SwitchGroup", props: { as: { type: [Object, String], default: "template" } }, setup(l2, { slots: c, attrs: o2 }) {
  ...
  } } }), f2 = k$1({ name: "SwitchDescription" });
  return provide(g, { switchRef: r, labelledby: p2, describedby: f2 }), () => A$3({ theirProps: l2, ourProps: {}, slot: {}, slots: c, attrs: o2, name: "SwitchGroup" });
} });
let ue = defineComponent({ name: "Switch", emits: { "update:modelValue": (l2) => true }, props: { as: { type: [Object, String], default: "button" }, modelValue: { type: Boolean, default: void 0 }, defaultChecked: { type: Boolean, optional: true }, form: { type: String, optional: true }, name: { type: String, optional: true }, value: { type: String, optional: true }, id: { type: String, default: null } }, inheritAttrs: false, setup(l2, { emit: c, attrs: o$2$1, slots: r, expose: p$1 }) {
  var h$1;
  let f$1 = (h$1 = l2.id) != null ? h$1 : `headlessui-switch-${I$1()}`, n = inject(g, null), [t, s$2] = d$1(computed(() => l2.modelValue), (e) => c("update:modelValue", e), computed(() => l2.defaultChecked));
  function m() {
    s$2(!t.value);
  }
  let k2 = ref(null), u = n === null ? k2 : n.switchRef, C = s$4(computed(() => ({ as: l2.as, type: o$2$1.type })), u);
  p$1({ el: u, $el: u });
  function E2(e) {
    e.preventDefault(), m();
  }
  ...
  let d2 = computed(() => {
    var e, i;
    return (i = (e = o$2(u)) == null ? void 0 : e.closest) == null ? void 0 : i.call(e, "form");
  });
  return onMounted(() => {
    watch([d2], () => {
    ...
    return h(Fragment, [e != null && t.value != null ? h(f, E$2({ features: s$3.Hidden, as: "input", type: "checkbox", hidden: true, readOnly: true, checked: t.value, form: R, name: e, value: i })) : null, A$3({ ourProps: T$1, theirProps: { ...o$2$1, ...T$2(K, ["modelValue", "defaultChecked"]) }, slot: x, attrs: o$2$1, slots: r, name: "Switch" })]);
  };
} });
...
//# sourceMappingURL=pricing--aGpq6De.mjs.map
