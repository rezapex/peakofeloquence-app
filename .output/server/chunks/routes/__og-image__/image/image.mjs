import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { l as hash, f as useRuntimeConfig, w as toRouteMatcher, x as createRouter, y as withoutTrailingSlash, z as defu, A as withoutBase, B as defineDriver, C as createStorage, q as useOgImageRuntimeConfig, p as parseURL, i as createError, h as getQuery, D as withQuery, u as useNitroApp, E as withoutLeadingSlash, F as normalizeKey, G as prefixStorage, H as withTrailingSlash, I as useStorage, J as handleCacheHeaders, K as setHeaders, L as setHeader, o as defineEventHandler, M as H3Error } from '../../../runtime.mjs';
import { LRUCache } from 'lru-cache';
import { s as separateProps, n as normaliseFontInput } from '../../../_/pure.mjs';
