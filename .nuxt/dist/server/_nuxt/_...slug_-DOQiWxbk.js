...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: page } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(route.path, () => queryContent(route.path).findOne(), "$tVA6J66VEN")), __temp = await __temp, __restore(), __temp);
    if (!page.value) {
...
//# sourceMappingURL=_...slug_-DOQiWxbk.js.map
