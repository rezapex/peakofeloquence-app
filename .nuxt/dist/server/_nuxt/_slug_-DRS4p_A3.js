import { u as useRoute, e as useAsyncData, q as queryContent, c as createError, f as useSeoMeta, i as useSiteConfig, _ as __nuxt_component_0, j as __nuxt_component_1, k as __nuxt_component_0$1, l as __nuxt_component_1$1, a as _sfc_main$2 } from "../server.mjs";
import { _ as _sfc_main$1, a as _sfc_main$3 } from "./PageBody-Cqm_-HOG.js";
import _sfc_main$4 from "./ContentRenderer-CU-6GHfd.js";
import { _ as _sfc_main$5, a as _sfc_main$6 } from "./ContentToc-DbpkDU3I.js";
...
import "destr";
import "cookie-es";
import "./ContentRendererMarkdown-nk5K2-Er.js";
              ...
              _push2(ssrRenderComponent(_component_UPageHeader, {
                ...
                headline: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(`<span class="text-gray-500 dark:text-gray-400"${_scopeId2}>·</span><time class="text-gray-500 dark:text-gray-400"${_scopeId2}>${ssrInterpolate(new Date(unref(post).date).toLocaleDateString("en", { year: "numeric", month: "short", day: "numeric" }))}</time>`);
                  } else {
                    return [
                      createVNode(_component_UBadge, mergeProps(unref(post).badge, { variant: "subtle" }), null, 16),
                      createVNode("span", { class: "text-gray-500 dark:text-gray-400" }, "·"),
...
//# sourceMappingURL=_slug_-DRS4p_A3.js.map
