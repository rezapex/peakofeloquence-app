import { F as useRequestEvent, E as useRuntimeConfig, G as resolveSitePath, d as useRouter, H as useServerHead } from "../server.mjs";
import { computed, unref } from "vue";
import { withoutProtocol, joinURL } from "ufo";
import { getRequestHost, getRequestProtocol } from "h3";
import { u as useSiteConfig } from "./useSiteConfig-KML5ykE2.js";
...
function useNitroOrigin(e) {
  {
    ...
    if (!e) {
      if (process.env.prerender && process.env.NUXT_VITE_NODE_OPTIONS) {
...
export {
  defineOgImageCached as a,
  defineOgImageWithoutCache as b,
  defineOgImageScreenshot as c,
  defineOgImage as d
};
//# sourceMappingURL=defineOgImage-_NAs6BPa.js.map
