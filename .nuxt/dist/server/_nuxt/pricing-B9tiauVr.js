import { I, G as A, H as k, J as s, K as o, L as f, M as E$1, N as u, T, O as o$1, n as useUI, B as __nuxt_component_1, k as __nuxt_component_0, P as l, Q as useId, R as useAppConfig, j as __nuxt_component_1$1, S as __nuxt_component_0$2, e as useAsyncData, q as queryContent, c as createError, f as useSeoMeta, _ as __nuxt_component_0$3 } from "../server.mjs";
import { ref, computed, provide, defineComponent, onMounted, onUnmounted, unref, inject, watch, h, Fragment, toRef, mergeProps, useSSRContext, isRef, withCtx, openBlock, createBlock, renderSlot, createTextVNode, toDisplayString, createCommentVNode, createVNode, createSlots, renderList, withAsyncContext } from "vue";
...
import { _ as __nuxt_component_0$1 } from "./Card-ru04_bD8.js";
import { _ as __nuxt_component_2 } from "./Divider-BDQDqPx6.js";
import { _ as _sfc_main$7 } from "./LandingSection-CeiyH_1n.js";
import { d as defineOgImage } from "./defineOgImage-DSkpf_RL.js";
import "ofetch";
...
let ue = defineComponent({ name: "Switch", emits: { "update:modelValue": (l2) => true }, props: { as: { type: [Object, String], default: "button" }, modelValue: { type: Boolean, default: void 0 }, defaultChecked: { type: Boolean, optional: true }, form: { type: String, optional: true }, name: { type: String, optional: true }, value: { type: String, optional: true }, id: { type: String, default: null }, disabled: { type: Boolean, default: false }, tabIndex: { type: Number, default: 0 } }, inheritAttrs: false, setup(l2, { emit: c, attrs: i, slots: r, expose: f$1 }) {
  ...
  let E2 = ref(null), o$2 = n === null ? E2 : n.switchRef, L = s(computed(() => ({ as: l2.as, type: i.type })), o$2);
  f$1({ el: o$2, $el: o$2 });
  function D(e) {
    e.preventDefault(), m();
  }
  ...
  return onMounted(() => {
    ...
    let { name: e, value: a2, form: K, tabIndex: y, ...b } = l2, T$1 = { checked: t.value }, B = { id: p$1, ref: o$2, role: "switch", type: L.value, tabIndex: y === -1 ? 0 : y, "aria-checked": t.value, "aria-labelledby": n == null ? void 0 : n.labelledby.value, "aria-describedby": n == null ? void 0 : n.describedby.value, onClick: D, onKeyup: R, onKeypress: x };
    return h(Fragment, [e != null && t.value != null ? h(f, E$1({ features: u.Hidden, as: "input", type: "checkbox", hidden: true, readOnly: true, checked: t.value, form: K, disabled: b.disabled, name: e, value: a2 })) : null, A({ ourProps: B, theirProps: { ...i, ...T(b, ["modelValue", "defaultChecked"]) }, slot: T$1, attrs: i, slots: r, name: "Switch" })]);
  };
} });
...
//# sourceMappingURL=pricing-B9tiauVr.js.map
