import { u as useRoute, f as useAsyncData, q as queryContent, c as createError, g as useSeoMeta, w as findPageHeadline, a as _sfc_main$1 } from "../server.mjs";
import { _ as _sfc_main$2, a as _sfc_main$3 } from "./PageBody-CCe_dp5i.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: page } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(route.path, () => queryContent(route.path).findOne(), "$P5dhnBsQvZ")), __temp = await __temp, __restore(), __temp);
    if (!page.value) {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/letters/[...slug].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
export {
  _sfc_main as default
};
//# sourceMappingURL=_...slug_-D2hvaMXf.js.map
