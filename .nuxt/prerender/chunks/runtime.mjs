...
storage.mount('og-image', unstorage_47drivers_47memory({"driver":"memory"}));
...
const handlers = [
  ...
  { route: '/api/_content/cache.1714025085859.json', handler: _l6MDMm, lazy: false, middleware: false, method: "get" },
