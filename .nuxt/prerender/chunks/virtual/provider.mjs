import { html } from 'file:///Users/rezajafar/peakofeloquence-site/node_modules/satori-html/dist/index.js';
import { Buffer } from 'node:buffer';
import { b as base64ToArrayBuffer, r as readPublicAsset, a as readPublicAssetBase64, t as toBase64Image } from '../_/utils.mjs';
import { c as useStorage, d as decodeHtml, u as useRuntimeConfig } from '../runtime.mjs';
import { withBase } from 'file:///Users/rezajafar/peakofeloquence-site/node_modules/ufo/dist/index.mjs';
import sizeOf from 'file:///Users/rezajafar/peakofeloquence-site/node_modules/image-size/dist/index.js';
import { Resvg } from 'file:///Users/rezajafar/peakofeloquence-site/node_modules/@resvg/resvg-js/index.js';
import satori$2 from 'file:///Users/rezajafar/peakofeloquence-site/node_modules/satori/dist/index.js';
...
const SatoriRenderer = {
  ...
  createVNode: async function createVNode(options) {
    const html$1 = options.html || await globalThis.$fetch("/api/og-image-html", {
      params: {
        path: options.path,
        options: JSON.stringify(options)
      }
    });
    const body = html$1.match(/<body[^>]*>([\s\S]*)<\/body>/)?.[1] || html$1;
