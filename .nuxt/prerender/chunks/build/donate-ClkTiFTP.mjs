import { k as _export_sfc, _ as __nuxt_component_0$2 } from './server.mjs';
import { mergeProps, withCtx, createVNode, useSSRContext } from 'file:///Users/rezajafar/peakofeloquence-app/node_modules/vue/index.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_UContainer, mergeProps({ class: "donation-container" }, _attrs), {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<iframe id="kofiframe" src="https://ko-fi.com/peakofeloquence/?hidefeed=true&amp;widget=true&amp;embed=true&amp;preview=true" class="donation-iframe" title="peakofeloquence" data-v-df94c3ff${_scopeId}></iframe>`);
      } else {
        return [
          createVNode("iframe", {
            id: "kofiframe",
...
const donate = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-df94c3ff"]]);

export { donate as default };
//# sourceMappingURL=donate-ClkTiFTP.mjs.map
