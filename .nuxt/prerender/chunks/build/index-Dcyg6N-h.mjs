import { r as nuxtLinkProps, y as config$a, k as useUI, s as getNuxtLinkProps, t as getSlotChildrenText, e as _export_sfc, v as __nuxt_component_0$6, z as __nuxt_component_1$2, f as useAsyncData, q as queryContent, c as createError, g as useSeoMeta, _ as __nuxt_component_0$2, i as __nuxt_component_0$4, x as createSharedComposable, j as __nuxt_component_1$1, h as __nuxt_component_1 } from './server.mjs';
...
import { _ as _sfc_main$8 } from './LandingSection-BlnQFiVd.mjs';
import { _ as __nuxt_component_0$1 } from './nuxt-img-3HGWqrMR.mjs';
import { _ as __nuxt_component_0 } from './Card-DymAOAEY.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(page)) {
        _push(`<div${ssrRenderAttrs(_attrs)} data-v-6b4fa7c2>`);
        _push(ssrRenderComponent(_component_ULandingHero, {
                    ...
                    if (_push3) {
                      _push3(ssrRenderComponent(_component_NuxtLink, {
                        ...
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(`<span class="absolute inset-0" aria-hidden="true" data-v-6b4fa7c2${_scopeId3}></span>`);
                          } else {
                            return [
                              createVNode("span", {
                                class: "absolute inset-0",
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="absolute inset-0 landing-grid z-[-1] [mask-image:radial-gradient(100%_100%_at_top_right,white,transparent)]" data-v-6b4fa7c2${_scopeId}></div>`);
            } else {
              return [
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    ssrRenderList(unref(page).testimonials.items, (testimonial, index2) => {
                      _push3(`<div class="break-inside-avoid" data-v-6b4fa7c2${_scopeId2}>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6b4fa7c2"]]);

export { index as default };
//# sourceMappingURL=index-Dcyg6N-h.mjs.map
