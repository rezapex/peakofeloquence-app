import { hasInjectionContext, inject, version, ref, watchEffect, watch, getCurrentInstance, toRef, isRef, defineAsyncComponent, defineComponent, h as h$1, useAttrs, computed, toValue, useSSRContext, provide, createElementBlock, onMounted, onUnmounted, Fragment, unref, Teleport, reactive, shallowRef, normalizeClass, mergeProps, withCtx, openBlock, createBlock, createVNode, createCommentVNode, createTextVNode, toDisplayString, shallowReactive, Suspense, nextTick, Transition, onServerPrefetch, useSlots, resolveDynamicComponent, renderSlot, resolveComponent, cloneVNode, withAsyncContext, createSlots, renderList, createApp, effectScope, onErrorCaptured, isReadonly, withKeys as withKeys$1, withDirectives, vShow, isShallow, isReactive, toRaw } from 'file:///Users/rezajafar/peakofeloquence-site/node_modules/vue/index.mjs';
import { $fetch as $fetch$1 } from 'file:///Users/rezajafar/peakofeloquence-site/node_modules/ofetch/dist/node.mjs';
import { createHooks } from 'file:///Users/rezajafar/peakofeloquence-site/node_modules/hookable/dist/index.mjs';
import { getContext } from 'file:///Users/rezajafar/peakofeloquence-site/node_modules/unctx/dist/index.mjs';
import { createError as createError$1, getRequestHeader, setCookie, getCookie, deleteCookie, sanitizeStatusCode } from 'file:///Users/rezajafar/peakofeloquence-site/node_modules/h3/dist/index.mjs';
import { hasProtocol, parseURL, withLeadingSlash, withBase, withTrailingSlash, withoutTrailingSlash, joinURL, parseQuery, withQuery, isScriptProtocol, withHttps } from 'file:///Users/rezajafar/peakofeloquence-site/node_modules/ufo/dist/index.mjs';
import { getActiveHead } from 'file:///Users/rezajafar/peakofeloquence-site/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin, composableNames, unpackMeta } from 'file:///Users/rezajafar/peakofeloquence-site/node_modules/@unhead/shared/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/rezajafar/peakofeloquence-site/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file:///Users/rezajafar/peakofeloquence-site/node_modules/radix3/dist/index.mjs';
import { defuFn, createDefu, defu } from 'file:///Users/rezajafar/peakofeloquence-site/node_modules/defu/dist/defu.mjs';
import { klona } from 'file:///Users/rezajafar/peakofeloquence-site/node_modules/klona/dist/index.mjs';
import { createSharedComposable, useActiveElement } from 'file:///Users/rezajafar/peakofeloquence-site/node_modules/@vueuse/core/index.mjs';
import { extendTailwindMerge, twMerge, twJoin } from 'file:///Users/rezajafar/peakofeloquence-site/node_modules/tailwind-merge/dist/bundle-mjs.mjs';
import { ssrRenderAttrs, ssrRenderList, ssrRenderComponent, ssrRenderClass, ssrInterpolate, ssrRenderSlot, ssrRenderVNode, ssrRenderStyle, ssrRenderSuspense, ssrIncludeBooleanAttr, ssrRenderTeleport } from 'file:///Users/rezajafar/peakofeloquence-site/node_modules/vue/server-renderer/index.mjs';
import { hash as hash$2, isEqual } from 'file:///Users/rezajafar/peakofeloquence-site/node_modules/ohash/dist/index.mjs';
import { Icon as Icon$2 } from 'file:///Users/rezajafar/peakofeloquence-site/node_modules/@iconify/vue/dist/offline.mjs';
import { addAPIProvider, loadIcon } from 'file:///Users/rezajafar/peakofeloquence-site/node_modules/@iconify/vue/dist/iconify.mjs';
import { splitByCase, upperFirst } from 'file:///Users/rezajafar/peakofeloquence-site/node_modules/scule/dist/index.mjs';
import destr from 'file:///Users/rezajafar/peakofeloquence-site/node_modules/destr/dist/index.mjs';
import { parse } from 'file:///Users/rezajafar/peakofeloquence-site/node_modules/cookie-es/dist/index.mjs';
import { u as useRuntimeConfig$1 } from '../runtime.mjs';
...
const _routes = [
  {
    ...
    component: () => import('./_...slug_-MdzfdNrU.mjs').then((m2) => m2.default || m2)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-BhVKTvOx.mjs').then((m2) => m2.default || m2)
  }
];
...
const LazyCallout = defineAsyncComponent(() => import('./Callout-DcjMtByk.mjs').then((r2) => r2.default));
const LazyCard = defineAsyncComponent(() => import('./Card-DWqd7oGF.mjs').then((r2) => r2.default));
const LazyCardGroup = defineAsyncComponent(() => import('./CardGroup-BD2DzMNt.mjs').then((r2) => r2.default));
const LazyCodeGroup = defineAsyncComponent(() => import('./CodeGroup-Dgv2MwfJ.mjs').then((r2) => r2.default));
const LazyCollapsible = defineAsyncComponent(() => import('./Collapsible-B-Qzx0Dk.mjs').then((r2) => r2.default));
const LazyField = defineAsyncComponent(() => import('./Field-Cn3yNwcH.mjs').then((r2) => r2.default));
const LazyFieldGroup = defineAsyncComponent(() => import('./FieldGroup-Sg52Xn_b.mjs').then((r2) => r2.default));
const LazyShortcut = defineAsyncComponent(() => import('./Shortcut-YgSecAxg.mjs').then((r2) => r2.default));
const LazyTabs = defineAsyncComponent(() => import('./Tabs-PjgsHvPn.mjs').then((r2) => r2.default));
const LazyProseCode = defineAsyncComponent(() => import('./ProseCode-CRBOd-SS.mjs').then((r2) => r2.default));
const LazyProseCodeButton = defineAsyncComponent(() => import('./ProseCodeButton-BE_FPi0R.mjs').then((r2) => r2.default));
const LazyProseCodeIcon = defineAsyncComponent(() => import('./ProseCodeIcon-x2TRaTNU.mjs').then((r2) => r2.default));
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-U9nLxngO.mjs').then((r2) => r2.default));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-J02i8zp8.mjs').then((r2) => r2.default));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-DAH0HpvX.mjs').then((r2) => r2.default));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-EPomLq0b.mjs').then((r2) => r2.default));
const LazyContentDoc = defineAsyncComponent(() => import('./ContentDoc-BAzGOLMs.mjs').then((r2) => r2.default));
const LazyContentList = defineAsyncComponent(() => import('./ContentList-D3atTJbO.mjs').then((r2) => r2.default));
const LazyContentNavigation = defineAsyncComponent(() => import('./ContentNavigation-ClzRP2gh.mjs').then((r2) => r2.default));
const LazyContentQuery = defineAsyncComponent(() => import('./ContentQuery-CwVzfGw-.mjs').then((r2) => r2.default));
const LazyContentRenderer = defineAsyncComponent(() => import('./ContentRenderer-eaAAF609.mjs').then((r2) => r2.default));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./ContentRendererMarkdown-yGM1WHyg.mjs').then((r2) => r2.default));
const LazyContentSlot = defineAsyncComponent(() => import('./ContentSlot-COO71Xql.mjs').then((r2) => r2.default));
const LazyDocumentDrivenEmpty = defineAsyncComponent(() => import('./DocumentDrivenEmpty-CVfz7tly.mjs').then((r2) => r2.default));
const LazyDocumentDrivenNotFound = defineAsyncComponent(() => import('./DocumentDrivenNotFound-4pTrsASA.mjs').then((r2) => r2.default));
const LazyMarkdown = defineAsyncComponent(() => import('./Markdown-DcNPyTRU.mjs').then((r2) => r2.default));
const LazyProseCodeInline = defineAsyncComponent(() => import('./ProseCodeInline-DaSvdlEi.mjs').then((r2) => r2.default));
const LazyProsePre = defineAsyncComponent(() => import('./ProsePre-Dhsjc5UN.mjs').then((r2) => r2.default));
const LazyProseA = defineAsyncComponent(() => import('./ProseA-B8G23Whc.mjs').then((r2) => r2.default));
const LazyProseBlockquote = defineAsyncComponent(() => import('./ProseBlockquote-BVbElnYX.mjs').then((r2) => r2.default));
const LazyProseEm = defineAsyncComponent(() => import('./ProseEm-BVgOI5Nm.mjs').then((r2) => r2.default));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-uLPNQQOC.mjs').then((r2) => r2.default));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-CpEuYzHn.mjs').then((r2) => r2.default));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-yNX4jF1Q.mjs').then((r2) => r2.default));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-D60sf1d7.mjs').then((r2) => r2.default));
const LazyProseLi = defineAsyncComponent(() => import('./ProseLi-Cl1UMePR.mjs').then((r2) => r2.default));
const LazyProseOl = defineAsyncComponent(() => import('./ProseOl-Dwqxjdax.mjs').then((r2) => r2.default));
const LazyProseP = defineAsyncComponent(() => import('./ProseP-BR-qOP0f.mjs').then((r2) => r2.default));
const LazyProseScript = defineAsyncComponent(() => import('./ProseScript-D0R07iM6.mjs').then((r2) => r2.default));
const LazyProseStrong = defineAsyncComponent(() => import('./ProseStrong-DOk1jSwG.mjs').then((r2) => r2.default));
const LazyProseTable = defineAsyncComponent(() => import('./ProseTable-CynEp7pT.mjs').then((r2) => r2.default));
const LazyProseTbody = defineAsyncComponent(() => import('./ProseTbody-C9cezVIK.mjs').then((r2) => r2.default));
const LazyProseTd = defineAsyncComponent(() => import('./ProseTd-B2JlT8uA.mjs').then((r2) => r2.default));
const LazyProseTh = defineAsyncComponent(() => import('./ProseTh-D08s7sqq.mjs').then((r2) => r2.default));
const LazyProseThead = defineAsyncComponent(() => import('./ProseThead-CW5BYQfc.mjs').then((r2) => r2.default));
const LazyProseTr = defineAsyncComponent(() => import('./ProseTr-Bi0qxuKK.mjs').then((r2) => r2.default));
const LazyProseUl = defineAsyncComponent(() => import('./ProseUl-DGIx9J9b.mjs').then((r2) => r2.default));
...
const LazyIconCSS = defineAsyncComponent(() => import('./IconCSS-D_x4BJoG.mjs').then((r2) => r2.default));
const LazyOgImageStatic = defineAsyncComponent(() => import('./Static-B4MsDb-d.mjs').then((r2) => r2.default));
const LazyOgImageDynamic = defineAsyncComponent(() => import('./Dynamic-DGehATmV.mjs').then((r2) => r2.default));
const LazyOgImage = defineAsyncComponent(() => import('./index-BzKcfQF-.mjs').then((r2) => r2.default));
const LazyOgImageCached = defineAsyncComponent(() => import('./Cached-BbIeZ0z8.mjs').then((r2) => r2.default));
const LazyOgImageWithoutCache = defineAsyncComponent(() => import('./WithoutCache-bocTwfIm.mjs').then((r2) => r2.default));
const LazyOgImageScreenshot = defineAsyncComponent(() => import('./Screenshot-DK5ggBZa.mjs').then((r2) => r2.default));
...
const __nuxt_component_0$4 = /* @__PURE__ */ _export_sfc(_sfc_main$s, [["__scopeId", "data-v-e8d572f6"]]);
...
const layouts = {
  docs: () => import('./docs-D32xyIPU.mjs').then((m2) => m2.default || m2)
};
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-CGU5tagK.mjs').then((m2) => m2.useContentDatabase());
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-CGU5tagK.mjs').then((m2) => m2.generateNavigation);
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLoadingIndicator = __nuxt_component_0$9;
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./island-renderer-B5o_9e3a.mjs').then((r2) => r2.default || r2));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
