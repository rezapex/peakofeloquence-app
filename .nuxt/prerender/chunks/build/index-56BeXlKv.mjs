import { t as nuxtLinkProps, z as config$a, n as useUI, v as getNuxtLinkProps, w as getSlotChildrenText, h as _export_sfc, x as __nuxt_component_0$6, A as __nuxt_component_1$2, e as useAsyncData, q as queryContent, c as createError, f as useSeoMeta, _ as __nuxt_component_0$2, k as __nuxt_component_0$4, y as createSharedComposable, l as __nuxt_component_1$1, j as __nuxt_component_1 } from './server.mjs';
import { useSSRContext, defineComponent, computed, ref, useSlots, toRef, unref, mergeProps, withCtx, createVNode, openBlock, createBlock, createCommentVNode, renderSlot, createTextVNode, toDisplayString, Fragment, renderList, withAsyncContext } from 'file:///Users/rezajafar/peakofeloquence-app/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderClass, ssrRenderSlot, ssrInterpolate, ssrRenderList } from 'file:///Users/rezajafar/peakofeloquence-app/node_modules/vue/server-renderer/index.mjs';
import { twJoin } from 'file:///Users/rezajafar/peakofeloquence-app/node_modules/tailwind-merge/dist/bundle-mjs.mjs';
import { _ as _sfc_main$8 } from './LandingSection-DzQk8SbZ.mjs';
import { _ as __nuxt_component_0$1 } from './nuxt-img-9JTEaDEL.mjs';
import { _ as __nuxt_component_0 } from './Card-ru04_bD8.mjs';
import { u as useMouse } from './index-Df99oxY9.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(page)) {
        _push(`<div${ssrRenderAttrs(_attrs)} data-v-dc134d25>`);
        _push(ssrRenderComponent(_component_ULandingHero, {
          ...
          title: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<h1 class="font-light text-4xl md:text-5xl mb-6 uppercase text-white text-shadow" data-v-dc134d25${_scopeId}>${ssrInterpolate(unref(page).hero.title)} <br data-v-dc134d25${_scopeId}><strong data-v-dc134d25${_scopeId}>Nahjul Balagha</strong></h1>`);
            } else {
              return [
                createVNode("h1", { class: "font-light text-4xl md:text-5xl mb-6 uppercase text-white text-shadow" }, [
                  createTextVNode(toDisplayString(unref(page).hero.title) + " ", 1),
                  createVNode("br"),
                  createVNode("strong", null, "Nahjul Balagha")
                ])
              ];
            }
          }),
                    ...
                    if (_push3) {
                      _push3(ssrRenderComponent(_component_NuxtLink, {
                        ...
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(`<span class="absolute inset-0" aria-hidden="true" data-v-dc134d25${_scopeId3}></span>`);
                          } else {
                            return [
                              createVNode("span", {
                                class: "absolute inset-0",
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="absolute inset-0 landing-grid z-[-1] [mask-image:radial-gradient(100%_100%_at_top_right,white,transparent)]" data-v-dc134d25${_scopeId}></div>`);
            } else {
              return [
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    ssrRenderList(unref(page).testimonials.items, (testimonial, index2) => {
                      _push3(`<div class="break-inside-avoid" data-v-dc134d25${_scopeId2}>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-dc134d25"]]);

export { index as default };
//# sourceMappingURL=index-56BeXlKv.mjs.map
