...
import { _ as _sfc_main$1, a as _sfc_main$2 } from './ContentSearchButton-CT9W3X9E.mjs';
import { defineComponent, inject, ref, computed, mergeProps, withCtx, createVNode, unref, useSSRContext } from 'file:///Users/rezajafar/peakofeloquence-app/node_modules/vue/index.mjs';
...
import './useShortcuts-PLAvQ_cW.mjs';
import './index-Df99oxY9.mjs';
  ...
  setup(__props) {
    ...
    const links = computed(
      () => {
        var _a2;
        var _a;
        return (_a2 = (_a = navigation.value.find((item) => item._path === "/letters")) == null ? void 0 : _a.children) != null ? _a2 : [];
      }
    );
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/letters.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=letters-BfNMtzwN.mjs.map
