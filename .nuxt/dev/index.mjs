...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHost, getRequestProtocol, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getQuery as getQuery$1, getRequestHeaders, setHeader, getCookie, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, readBody, getResponseStatusText, H3Error } from 'file:///Users/rezajafar/peakofeloquence-app/node_modules/h3/dist/index.mjs';
...
import { createStorage, prefixStorage, normalizeKey } from 'file:///Users/rezajafar/peakofeloquence-app/node_modules/unstorage/dist/index.mjs';
import lruCacheDriver from 'file:///Users/rezajafar/peakofeloquence-app/node_modules/unstorage/drivers/lru-cache.mjs';
import { html as html$2 } from 'file:///Users/rezajafar/peakofeloquence-app/node_modules/satori-html/dist/index.js';
...
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, hasProtocol, withHttps, withoutProtocol, joinRelativeURL, withoutTrailingSlash, withoutLeadingSlash, withLeadingSlash, isRelative, withBase } from 'file:///Users/rezajafar/peakofeloquence-app/node_modules/ufo/dist/index.mjs';
...
import { extname, isAbsolute } from 'file:///Users/rezajafar/peakofeloquence-app/node_modules/pathe/dist/index.mjs';
...
import _satori from 'file:///Users/rezajafar/peakofeloquence-app/node_modules/satori/dist/index.js';
import sharp from 'file:///Users/rezajafar/peakofeloquence-app/node_modules/sharp/lib/index.js';
...
const serverAssets = [{"baseName":"nuxt-og-image:fonts","dir":"/Users/rezajafar/peakofeloquence-app/.nuxt/cache/nuxt-og-image@3.0.0-rc.53/_fonts"},{"baseName":"server","dir":"/Users/rezajafar/peakofeloquence-app/server/assets"}];
...
const _MhrCBR54jc = (function(nitro) {
...
const _ZGCndCpu4k = defineNitroPlugin(async (nitroApp) => {
...
const _qWxQCYtsPg = defineNitroPlugin((nitroApp) => {
...
const _Y86YJQyueQ = defineNitroPlugin(async (nitro) => {
  return;
});
...
const _sky0rPERtF = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const _3cyxsG = eventHandler(async (event) => {
...
const _jP61iD = defineEventHandler(async (e) => {
...
const _8Y9jNP = defineEventHandler(async (e) => {
...
const _sx3VcX = defineEventHandler(async (event) => {
...
const _uAdXzq = defineEventHandler(async (event) => {
...
const _pCfjH6 = defineEventHandler(async (event) => {
  const query = getContentQuery(event);
...
const _MAIrxQ = lazyEventHandler(() => {
...
const _lazy_G7KJDK = () => Promise.resolve().then(function () { return renderer$1; });
const _lazy_xp8YRM = () => Promise.resolve().then(function () { return font$1; });
const _lazy_Vn7wH3 = () => Promise.resolve().then(function () { return debug_json$1; });
const _lazy_nlf1V1 = () => Promise.resolve().then(function () { return image$1; });

const handlers = [
  { route: '/api/search.json', handler: _lazy_cu2Ofs, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_G7KJDK, lazy: true, middleware: false, method: undefined },
  { route: '/api/_mdc/highlight', handler: _3cyxsG, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _jP61iD, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _8Y9jNP, lazy: false, middleware: false, method: undefined },
  { route: '/__og-image__/font/**', handler: _lazy_xp8YRM, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/debug.json', handler: _lazy_Vn7wH3, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/image/**', handler: _lazy_nlf1V1, lazy: true, middleware: false, method: undefined },
  { route: '/api/_content/query/:qid/**:params', handler: _sx3VcX, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query/:qid', handler: _sx3VcX, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query', handler: _sx3VcX, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/cache.json', handler: _uAdXzq, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid/**:params', handler: _pCfjH6, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _pCfjH6, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _pCfjH6, lazy: false, middleware: false, method: "get" },
  { route: '/_ipx/**', handler: _MAIrxQ, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_G7KJDK, lazy: true, middleware: false, method: undefined }
];
...
const theme = {"colors":{"background":"rgb(var(--ui-background) / <alpha-value>)","foreground":"rgb(var(--ui-foreground) / <alpha-value>)","primary":{"50":"rgb(var(--color-primary-50) / <alpha-value>)","100":"rgb(var(--color-primary-100) / <alpha-value>)","200":"rgb(var(--color-primary-200) / <alpha-value>)","300":"rgb(var(--color-primary-300) / <alpha-value>)","400":"rgb(var(--color-primary-400) / <alpha-value>)","500":"rgb(var(--color-primary-500) / <alpha-value>)","600":"rgb(var(--color-primary-600) / <alpha-value>)","700":"rgb(var(--color-primary-700) / <alpha-value>)","800":"rgb(var(--color-primary-800) / <alpha-value>)","900":"rgb(var(--color-primary-900) / <alpha-value>)","950":"rgb(var(--color-primary-950) / <alpha-value>)","DEFAULT":"rgb(var(--color-primary-DEFAULT) / <alpha-value>)"},"gray":{"50":"rgb(var(--color-gray-50) / <alpha-value>)","100":"rgb(var(--color-gray-100) / <alpha-value>)","200":"rgb(var(--color-gray-200) / <alpha-value>)","300":"rgb(var(--color-gray-300) / <alpha-value>)","400":"rgb(var(--color-gray-400) / <alpha-value>)","500":"rgb(var(--color-gray-500) / <alpha-value>)","600":"rgb(var(--color-gray-600) / <alpha-value>)","700":"rgb(var(--color-gray-700) / <alpha-value>)","800":"rgb(var(--color-gray-800) / <alpha-value>)","900":"rgb(var(--color-gray-900) / <alpha-value>)","950":"rgb(var(--color-gray-950) / <alpha-value>)"},"cool":{"50":"#f9fafb","100":"#f3f4f6","200":"#e5e7eb","300":"#d1d5db","400":"#9ca3af","500":"#6b7280","600":"#4b5563","700":"#374151","800":"#1f2937","900":"#111827","950":"#030712"}},"fontFamily":{"serif":["Playfair Display","ui-serif","Georgia","Cambria","\"Times New Roman\"","Times","serif","Playfair Display","ui-serif","Georgia","Cambria","\"Times New Roman\"","Times","serif","Playfair Display","ui-serif","Georgia","Cambria","\"Times New Roman\"","Times","serif","Playfair Display","ui-serif","Georgia","Cambria","\"Times New Roman\"","Times","serif"],"sans":["DM Sans","ui-sans-serif","system-ui","sans-serif","\"Apple Color Emoji\"","\"Segoe UI Emoji\"","\"Segoe UI Symbol\"","\"Noto Color Emoji\"","DM Sans","ui-sans-serif","system-ui","sans-serif","\"Apple Color Emoji\"","\"Segoe UI Emoji\"","\"Segoe UI Symbol\"","\"Noto Color Emoji\"","DM Sans","ui-sans-serif","system-ui","sans-serif","\"Apple Color Emoji\"","\"Segoe UI Emoji\"","\"Segoe UI Symbol\"","\"Noto Color Emoji\"","DM Sans","ui-sans-serif","system-ui","sans-serif","\"Apple Color Emoji\"","\"Segoe UI Emoji\"","\"Segoe UI Symbol\"","\"Noto Color Emoji\""]}};
