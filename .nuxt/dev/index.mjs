...
const serverAssets = [{"baseName":"nuxt-og-image:fonts","dir":"/Users/rezajafar/peakofeloquence-app/.nuxt/cache/nuxt-og-image@3.0.0-rc.52/_fonts"},{"baseName":"server","dir":"/Users/rezajafar/peakofeloquence-app/server/assets"}];
...
const _lazy_du0BI5 = () => Promise.resolve().then(function () { return debug_json$1; });
const _lazy_IPTeSa = () => Promise.resolve().then(function () { return image$1; });
...
const handlers = [
  ...
  { route: '/__og-image__/debug.json', handler: _lazy_du0BI5, lazy: true, middleware: false, method: undefined },
